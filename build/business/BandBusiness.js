...
var BandBusiness = /** @class */ (function () {
    function BandBusiness() {
    }
    BandBusiness.prototype.createBand = function (band, token) {
        return __awaiter(this, void 0, void 0, function () {
            var userToken, idGenerator, id, bandDataBase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        userToken = new Authenticator_1.Authenticator().getData(token);
                        if (userToken == null) {
                        ...
                        bandDataBase = new BandDataBase_1.BandDatabase();
                        return [4 /*yield*/, bandDataBase.createBand(id, band.name, band.music_genre, band.responsible)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    BandBusiness.prototype.getBandById = function (token, sort) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenData, bandDataBase;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!token) {
                        ...
                        tokenData = new Authenticator_1.Authenticator().getData(token);
                        if (!tokenData) {
                            throw new Error("Não autorizado!");
                        }
                        bandDataBase = new BandDataBase_1.BandDatabase();
                        return [4 /*yield*/, bandDataBase.getBandById(tokenData.id, sort)];
                    case 1:
                        _a.sent();
                        if (!bandDataBase) {
                            throw new Error("Não tem banda registrada.");
                        }
                        return [2 /*return*/, bandDataBase];
                }
            });
        });
    };
