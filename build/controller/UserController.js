...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.signup = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var input, userBusiness, token, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userBusiness.createUser(input)];
                    case 1:
                        token = _a.sent();
    ...
    UserController.prototype.login = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var loginData, userBusiness, token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        ...
                        userBusiness = new UserBusiness_1.UserBusiness();
                        return [4 /*yield*/, userBusiness.getUserByEmail(loginData)];
                    case 1:
                        token = _a.sent();
                        console.log(token);
                        res.status(200).send({
                    ...
                    case 2:
                        error_2 = _a.sent();
                        res.status(400).send(error_2.slqMessage || error_2.message);
                        return [3 /*break*/, 3];
                    case 3: return [4 /*yield*/, BaseDatabase_1.BaseDatabase.destroyConnection()];
                    case 4:
                        _a.sent();
